        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                    	<a href="javascript:;" class="dropdwon-toggle">
            			<i class="icon_desktop"></i>
            			<span>관리자 페이지</span>
            			<span class="menu-arrow arrow_carrot-right"></span>
            			</a>
            			<ul class="sub">
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/Member.do">회원정보 관리</a></li>
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/Indicator.do">지표정보 관리</a></li>
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/Company.do">업체정보 관리</a></li>
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/Type.do">유형정보 관리</a></li>
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/Success.do">회원승인 관리</a></li>
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/Auth.do">회원권한 관리</a></li>
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/UserLog.do">회원기록 관리</a></li>
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/BoardLog.do">게시물 이력관리</a></li>
			              <li><a class="nav-item" href="<%=request.getContextPath()%>/Admin/CommentLog.do">댓글 이력관리</a></li>
			            </ul>
            		</li>
                </ul>
