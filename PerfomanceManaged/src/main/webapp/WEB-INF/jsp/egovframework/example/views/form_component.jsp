...
<head>
  ...
  <link href="<%=request.getContextPath()%>/resources/css/daterangepicker.css" rel="stylesheet" />
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="<%=request.getContextPath()%>/resources/index.html" class="logo">Nice <span class="lite">Admin</span></a>
      <!--logo end-->
  ...
  <!--custom checkbox & radio-->
  <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/ga.js"></script>
  <!--custom switch-->
  <script src="<%=request.getContextPath()%>/resources/js/bootstrap-switch.js"></script>
  <!--custom tagsinput-->
  <script src="<%=request.getContextPath()%>/resources/js/jquery.tagsinput.js"></script>
  ...
  <script src="<%=request.getContextPath()%>/resources/js/bootstrap-wysiwyg-custom.js"></script>
  <script src="<%=request.getContextPath()%>/resources/js/moment.js"></script>
  <script src="<%=request.getContextPath()%>/resources/js/bootstrap-colorpicker.js"></script>
  <script src="<%=request.getContextPath()%>/resources/js/daterangepicker.js"></script>
  <script src="<%=request.getContextPath()%>/resources/js/bootstrap-datepicker.js"></script>
  <!-- ck editor -->
  <script type="text/javascript" src="<%=request.getContextPath()%>/resources/assets/ckeditor/ckeditor.js"></script>
  <!-- custom form component script for this page-->
  <script src="<%=request.getContextPath()%>/resources/js/form-component.js"></script>
