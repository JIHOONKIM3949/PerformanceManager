...
public class PagerVO {
	...
	public PagerVO(String value, String murl, int rowsPerPage, int pagesPerGroup, int totalRows, int pageNo) {
		this(murl, rowsPerPage, pagesPerGroup, totalRows, pageNo);
		this.value = value;
	}

	public PagerVO(String murl, int rowsPerPage, int pagesPerGroup, int totalRows, int pageNo) {
